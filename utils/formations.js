const formationsPositions = {
  "4-4-2": [
    ...
    { x: 15, y: 70 }, // Left back
    { x: 38, y: 70 }, // Left center back
    { x: 62, y: 70 }, // Right center back
    { x: 85, y: 70 }, // Right back
    { x: 15, y: 40 }, // Left midfielder
    { x: 38, y: 40 }, // Left center midfielder
    { x: 62, y: 40 }, // Right center midfielder
    { x: 85, y: 40 }, // Right midfielder
    { x: 38, y: 15 }, // Left forward
    { x: 62, y: 15 }, // Right forward
  ],
  "3-5-2": [
    { x: 50, y: 90 }, // Goalkeeper
    { x: 20, y: 70 }, // Left CB
    ...
    { x: 80, y: 70 }, // Right CB
    { x: 90, y: 40 }, // right mid
    { x: 30, y: 40 }, // Left center midfielder
    { x: 50, y: 40 }, // Center midfielder
    { x: 70, y: 40 }, // Right center midfielder
    { x: 10, y: 40 }, // left mid
  ...
  "5-4-1": [
    { x: 50, y: 90 }, // Goalkeeper
    { x: 10, y: 70 }, // Left back
    { x: 70, y: 70 }, // Left center back
    { x: 50, y: 70 }, // center back
    { x: 30, y: 70 }, // Right center back
    { x: 90, y: 70 }, // left back
    { x: 15, y: 40 }, // right mid
    { x: 38, y: 40 }, // Right center midfielder
    { x: 62, y: 40 }, // lcm
    { x: 85, y: 40 }, // Left mid
    { x: 50, y: 15 }, // CF
  ],
  ...
  "3-4-3": [
    ...
    { x: 62, y: 45 }, // left cm
    { x: 85, y: 45 }, // left mid
    { x: 20, y: 15 }, // right forward
    { x: 50, y: 15 }, // cf
    { x: 80, y: 15 }, // left forward
  ],
  "3-1-4-2": [
    { x: 50, y: 90 }, // Goalkeeper
    { x: 20, y: 70 }, // Left CB
    ...
    { x: 62, y: 32 }, // left cm
    { x: 85, y: 32 }, // left mid
    { x: 35, y: 10 }, // right forward
    { x: 65, y: 10 }, // left forward
  ],
  "3-3-3-1": [
    { x: 50, y: 90 }, // Goalkeeper
    { x: 25, y: 70 }, // right CB
