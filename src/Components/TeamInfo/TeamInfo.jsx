...
const TeamInfo = () => {
  ...
  useEffect(() => {
    const fetchTeamData = async () => {
      try {
        const leaguesRes = await axios.get("https://v3.football.api-sports.io/leagues", {
          headers: {
        ...
        const currentSeasonData = leagueEntry?.seasons.find(season => season.current);
        ...
        const [teamRes, squadRes, fixturesRes, standingsRes] = await Promise.all([
